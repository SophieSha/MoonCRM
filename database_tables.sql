...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2019 at 02:10 PM
...
(1, 'Sales target', 'Displays the current weeks sales position and compares them to last week\'s position', 1, 1, 1, '2019-05-21 14:31:54');
...
INSERT INTO `users` (`id`, `username`, `password`, `department_id`, `created_at`) VALUES
(1, 'daniel', '$2y$10$bjTBjJxBfkAiiQD1E.JH6eOq.HaDhTRWRnCspAAjEpXlQJVu.QDPm', 2, '2019-05-27 18:48:42');
