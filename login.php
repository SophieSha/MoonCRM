...
<head>
    ...
    <style type="text/css">
        ...
        .wrapper{ width: 420px; padding: 53px; margin-left: auto; margin-right: auto; text-align: center }
        .title-color{color: #FED766}
        .button{width: 160px; padding: 6px; background-color:#2c2f33; color:#FED766; outline:#FED766 }
    </style>
